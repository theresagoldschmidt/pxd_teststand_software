...
/*typedef struct
{
	...
	voltage_limit_t voltage_limit;
	current_limit_t current_limit;
	amplitude_step_size_t step_size_t;
	time_step_size_t delta_t;
}
...
typedef struct{
	...
	//channel_descr_t channel;
	//monitor_channel_t monitor;
