...
/* LED control register for P83848J */
#define LEDCR                            0x18
#define LEDCR_LNKLED_FORCE_OFF           (0x02 | 0x10)
#define LEDCR_LNKLED_FORCE_ON            (0x00 | 0x10)
#define LEDCR_LNKLED_AUTO                0x00
#define LEDCR_SPEEDLED_FORCE_OFF         (0x04 | 0x20)
#define LEDCR_SPEEDLED_FORCE_ON          (0x00 | 0x20)
#define LEDCR_SPEEDLED_AUTO              0x00
...
#ifdef XME_BSP_STM32_ETHERNET_PHY_DP83848J
	// Workaround speed LED being permanently on:  Link should be up now:
	// Use PHY status to control link and speed LED
	ETH_WritePHYRegister(PHYAddress, LEDCR, LEDCR_LNKLED_AUTO | LEDCR_SPEEDLED_AUTO );
#endif // #ifdef XME_BSP_STM32_ETHERNET_PHY_DP83848J
