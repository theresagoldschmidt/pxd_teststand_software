...
#define XME_BSP_BUTTON_BOOTLOADER_CLOCK	XME_BSP_BUTTON_WAKEUP_CLOCK

/// Button to select bootloader mode: I/O port
#define XME_BSP_BUTTON_BOOTLOADER_PORT	XME_BSP_BUTTON_WAKEUP_PORT

/// Button to select bootloader mode: I/O pin
#define XME_BSP_BUTTON_BOOTLOADER_PIN	XME_BSP_BUTTON_WAKEUP_PIN
