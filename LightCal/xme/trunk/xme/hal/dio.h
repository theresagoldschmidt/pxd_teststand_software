...
/**
 * \typedef xme_hal_dio_pinConfiguration_t
 *
 ...
 *          - XME_CORE_SUCCESS if the operation completed successfully.
 *          - XME_CORE_INVALID_PARAMETER if the given port or output variable
 *            address is invalid.
 */
xme_core_status_t
 ...
 * \return Returns one of the following status codes:
 *          - XME_CORE_SUCCESS if the operation completed successfully.
 *          - XME_CORE_INVALID_PARAMETER if the given port is invalid.
 */
xme_core_status_t
 ...
 * \return Returns one of the following status codes:
 *          - XME_CORE_SUCCESS if the operation completed successfully.
 *          - XME_CORE_INVALID_PARAMETER if the given pin or output variable
 *            address is invalid.
 */
xme_core_status_t
 ...
 * \return Returns one of the following status codes:
 *          - XME_CORE_SUCCESS if the operation completed successfully.
 *          - XME_CORE_INVALID_PARAMETER if the given pin is invalid.
 *          - XME_CORE_INVALID_CONFIGURATION if the given configuration is
 *            not feasible (e.g., XME_HAL_DIO_PIN_INPUT_PULLDOWN is requested,
 *            but the hardware does not offer this functionality).
 */
xme_core_status_t
 ...
 * \return Returns one of the following status codes:
 *          - XME_CORE_SUCCESS if the operation completed successfully.
 *          - XME_CORE_INVALID_PARAMETER if the given port or output
 *            variable address is invalid.
 */
xme_core_status_t
 ...
 * \return Returns one of the following status codes:
 *          - XME_CORE_SUCCESS if the operation completed successfully.
 *          - XME_CORE_INVALID_PARAMETER if the given pin or output
 *            variable address is invalid.
 */
xme_core_status_t
